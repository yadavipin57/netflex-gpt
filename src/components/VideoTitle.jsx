  ...
  return (
    <div className="pt-[40%] md:pt-[15%] md:px-24 w-[100%] h-[100%] md:h-screen relative md:absolute z-100 text-white md:bg-gradient-to-br from-black">
      ...
      <div className="w-1/2">
        ...
        <button className="ml-2 mb-1 md:ml-0 md:mb-0 text-[10px] py-1 px-2 md:text-base md:mr-2 md:py-2 md:px-6 rounded-sm text-black font-bold bg-gray-200 hover:bg-opacity-75" onClick={handleMovieInfoClick}>
